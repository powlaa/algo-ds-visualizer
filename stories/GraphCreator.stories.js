import { GraphCreator } from "../src/static/js/components/GraphCreator";
...
const Template = ({ centerIcon, deleteIcon, helpIcon }) =>
...
document.addEventListener("DOMContentLoaded", (e) => {
    ...
    if (!e.isTrusted && graphCreator) {
        ...
        const edges = [
            ...
            { source: nodes[1], target: nodes[0], weight: 5 },
            { source: nodes[1], target: nodes[2], weight: 2 },
            { source: nodes[1], target: nodes[4], weight: 2 },
            { source: nodes[2], target: nodes[0], weight: 2 },
            { source: nodes[2], target: nodes[1], weight: 2 },
            { source: nodes[2], target: nodes[3], weight: 8 },
            { source: nodes[2], target: nodes[4], weight: 3 },
            { source: nodes[3], target: nodes[2], weight: 8 },
            { source: nodes[3], target: nodes[4], weight: 6 },
            { source: nodes[3], target: nodes[5], weight: 4 },
            { source: nodes[4], target: nodes[1], weight: 2 },
            { source: nodes[4], target: nodes[2], weight: 3 },
            { source: nodes[4], target: nodes[3], weight: 6 },
            { source: nodes[4], target: nodes[5], weight: 3 },
            { source: nodes[5], target: nodes[3], weight: 4 },
            { source: nodes[5], target: nodes[4], weight: 3 },
        ];
